...
- input_type:  The input file indicator. `csv` or  `ttl` . If  [csv](http://localhost:8089/quegg/) then the lexical entires are given in the form of rows in csv file. If  `ttl` then the lexical entries are given in lemon format.                                         
