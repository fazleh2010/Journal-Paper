...
```
Run the system:
- language: `EN` (English), `IT` (Italian), `FA` (Persian)
...
java -jar target/QuestionGrammarGenerator.jar FA lexicon/fa outputDB 10 csv dataset/dbpedia.json                                                                 
````  
Run Evaluation

````shell script
java -jar target/QuestionGrammarGenerator.jar FA qald outputDB dataset/dbpedia.json
````
