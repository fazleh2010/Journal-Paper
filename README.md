...
```shell script
git clone https://github.com/fazleh2010/question-grammar-generator.git -b english
```
build the jar file
```shell script
mvn clean install
...
java -jar target/QuestionGrammarGenerator.jar EN lexicon/en outputDB 10 csv dataset/dbpedia.json                                                                 
````  
Run Evaluation

````shell script
java -jar target/QuestionGrammarGenerator.jar EN qald outputDB dataset/dbpedia.json
````
