...
public class GenderUtils implements TempConstants{
    ...
    public static Map<String,Map<String,String>> trennVerbType = new TreeMap<String,Map<String,String>>();
    ...
    public static void setTrennVerbType(String key, Map<String,String> verbs) {
        trennVerbType.put(key, verbs);
    }
    
    public static void setPerfectVerbType(String key,Map<String,String> verbs) {
        perfectVerb.put(key, verbs);
    }
 ...
 /*public GenderUtils(String domain) {
    ...
    public static Pair<Boolean, String> getTrennVerbType(String key, String tense, String type) {
        Map<String, String> verb = trennVerbType.get(key);
    ...
    public static Pair<Boolean, String> getPerfecterbType(String key, String tense) {
        if (perfectVerb.containsKey(key)) {
            ...
            if (verb.containsKey(tense)) {
                return new Pair<Boolean, String>(Boolean.TRUE, verb.get(tense));
            }
        }
        return new Pair<Boolean, String>(Boolean.FALSE, key);
    }
    ...
    public static void display() {
        ...
        for(String key:writtenForms.keySet()){
            String []values=writtenForms.get(key);
