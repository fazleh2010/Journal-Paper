...
public interface TemplateConstants {
    ...
    public static final String WHEN_WHAT_DO_THING = "WHEN_WHAT_DO_THING";
    public static final String WHEN_WHO_DO_PERSON = "WHEN_WHO_DO_PERSON";
    ...
    public static final String WHERE_DO_PERSON = "WHERE_DO_PERSON";
