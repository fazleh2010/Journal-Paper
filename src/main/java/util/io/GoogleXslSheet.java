 ...
 * @author elahi
 */
public class GoogleXslSheet implements FrameConstants{
    ...
    public static  String prepositionVaribale= "prepos";
    ...
    public static class NounPPFrame {
        ...
        public static String getNounPPFrameHeader(String lemonEntry, String language) {
            return "@prefix :        <http://localhost:8080/lexicon#> .\n"
                    ...
                    + "  lemon:entry    :" + prepositionVaribale + " .\n"
                    + "\n";
        }
        ...
        public static String getPreposition(String preposition,String language ) {
            return ":arg2 lemon:marker :"+prepositionVaribale+" .\n"
                    + "\n"
                    + "## Prepositions ##\n"
                    + "\n"
                    + ":"+prepositionVaribale+" a                  lemon:SynRoleMarker ;\n"
  ...
  public static String getHeader(String lemonEntry,String language) {
        return "@prefix :        <http://localhost:8080/lexicon#> .\n"
                + "\n"
                + "@prefix lexinfo: <http://www.lexinfo.net/ontology/2.0/lexinfo#> .\n"
                + "@prefix lemon:   <http://lemon-model.net/lemon#> .\n"
    ...
    public static String getSenseDetail(List<Tupples> tupples, String syntacticFrame, String lemonEntry,String pastTense,String preposition,String language) {
        ...
        if (syntacticFrame.equals(GoogleXslSheet.TRANSITIVE_FRAME)) {
            ...
            String prep="\n"
                +":" + lemonEntry + "_obj lemon:marker :"+prepositionVaribale+" .\n"
                + "\n";
