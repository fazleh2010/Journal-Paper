...
public class ParamterFinder implements TempConstants {
    ...
    public ParamterFinder(String numberValue, String tenseValue, String personValue) {
        this.numberPair = new Pair<String, String>(number, numberValue);
        this.tensePair = new Pair<String, String>(tense, tenseValue);
        this.personPair = new Pair<String, String>(person, personValue);
    }
