...
public interface TemplateConstants {
    ...
    public static String NOUN_PP_FRAME = "NounPPFrame";
    public static String TRANSITIVE_FRAME = "TransitiveFrame";
    public static String IN_TRANSITIVE_PP_FRAME = "IntransitivePPFrame";
    public static String ADJECTIVE_ATTRIBUTIVE_FRAME = "AdjectiveAttributiveFrame";
    public static String ADJECTIVE_PP_FRAME = "AdjectivePPFrame";
