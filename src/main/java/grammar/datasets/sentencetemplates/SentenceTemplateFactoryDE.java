  ...
  private void initDE(Language language) {
    ...
    sentenceTemplateRepository.add(
      createSentenceTemplate(language,
        ...
        "interrogativePronoun(nominativeCase:range:singular) verb(component_be:past:singular) preposition(mit) object(domain) verb(mainVerb:perfect:thridPerson)??"     
        ),
        TransitiveFrame,
        passive
      )
    ...
    sentenceTemplateRepository.add(
      createSentenceTemplate(language,
        ...
        "interrogativeAmount(nominativeCase:singular) verb(component_haben:present:singular) adjunct(domain) verb(mainVerb:perfect:thridPerson)?"
