...
public class NPPGrammarRuleGenerator extends GrammarRuleGeneratorRoot {
    ...
    protected List<String> generateNounPhrase(LexicalEntryUtil lexicalEntryUtil,String type) throws
        ...
        if (type.equals(TemplateVariable.nounPhrase)) {
        ...
        } else if (type.equals(TemplateVariable.booleanQuestionDomainRange)) {
            generatedSentences = new ArrayList<String>();
        ...
        } else if (type.equals(TemplateVariable.booleanQuestionDomain)) {
            generatedSentences = new ArrayList<String>();
    ...
    public List<GrammarEntry> generateFragmentEntry(GrammarEntry grammarEntry, LexicalEntryUtil lexicalEntryUtil) throws
        ...
        sentences = generateNounPhrase(lexicalEntryUtil, TemplateVariable.booleanQuestionDomainRange);
        if (!sentences.isEmpty()) {
            GrammarEntry booleanGrammarEntryDomainRange = this.generateGrammarEntryforNP(grammarEntry, lexicalEntryUtil, SentenceType.SENTENCE, sentences,TemplateVariable.booleanQuestionDomainRange);
            grammarEntries.add(booleanGrammarEntryDomainRange);
        }
        sentences = generateNounPhrase(lexicalEntryUtil, TemplateVariable.booleanQuestionDomain);
        if (!sentences.isEmpty()) {
            GrammarEntry booleanGrammarEntryDomain = this.generateGrammarEntryforNP(grammarEntry, lexicalEntryUtil, SentenceType.SENTENCE, sentences,TemplateVariable.booleanQuestionDomain);
            grammarEntries.add(booleanGrammarEntryDomain);
        }
        sentences = generateNounPhrase(lexicalEntryUtil, TemplateVariable.nounPhrase);
        if (!sentences.isEmpty()) {
            GrammarEntry fragmentEntry = this.generateGrammarEntryforNP(grammarEntry, lexicalEntryUtil, SentenceType.NP, sentences,TemplateVariable.nounPhrase);
    ...
    private GrammarEntry generateGrammarEntryforNP(GrammarEntry grammarEntry, LexicalEntryUtil lexicalEntryUtil, SentenceType sentenceType, List<String> generatedSentences, String type) throws QueGGMissingFactoryClassException {
        ...
        if (type.contains(TemplateVariable.booleanQuestionDomainRange) || type.contains(TemplateVariable.booleanQuestionDomain)) {
