...
public class TransitiveVPGrammarRuleGeneratorLast extends GrammarRuleGeneratorRoot implements TempConstants {

    private static final Logger LOG = LogManager.getLogger(TransitiveVPGrammarRuleGeneratorLast.class);

    public TransitiveVPGrammarRuleGeneratorLast(Language language) {
    ...
    public List<String> generateSentences(
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransitiveVPGrammarRuleGeneratorLast.class.getName()).log(Level.SEVERE, null, ex);
        }
