...
public class Entity {
    ...
    public static void generateEntities(String entityDir,String inputFileName,
        ...
        QueGG.stringToFile(content,outputDir+type+".txt");
            ...
            while (line != null) {
                ...
                if (line != null) {
                    ...
                    for (String value : lines) {
                        index = index + 1;
                        if (index == 2) {
                            subject =  Matcher.clean(value,language);
                        } else if (index == 6) {
                            object =  Matcher.clean(value,language);
                        }
                        else if (index == 4) {
                            property =  Matcher.clean(value,language);
                        }
                    }
